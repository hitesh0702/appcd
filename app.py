...
# </style>
# <div class="footer">
# <p>Developed with ❤ by <a style='display: block; text-align: center;' href="https://github.com/hitesh0702" target="_blank">Hitesh Ahlawat</a></p>
# </div>
# """
# st.markdown(footer,unsafe_allow_html=True)
# st.markdown("_- Hitesh Ahlawat_")
